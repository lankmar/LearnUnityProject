...
namespace BerserkAdventure
{
    public class CameraController : MonoBehaviour
    {
        ...
        public void ObjectActvation() 
        {
            GameObject gameObject = InteractibleObjectSearch();
            if (!gameObject) return;
            if (gameObject.GetComponent<IInteractibleObject>() != null) gameObject.GetComponent<IInteractibleObject>().ActivationObject();
        }
        /// <summary>
        ...
        public void RotateCamera(float x, float y)
        {
            ...
            if (!lockCamera)
            {
                mouseY = Extension.ClampAngle(mouseY, yMinLimit, yMaxLimit);
                mouseX = Extension.ClampAngle(mouseX, xMinLimit, xMaxLimit);
            }
            else
            {
